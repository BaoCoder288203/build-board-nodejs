...
taskRouter.get("/archived", taskController.listArchived);
...
taskRouter.post("/:taskId/restore", taskController.restore);
...
taskRouter.post("/:taskId/watchers", taskController.watch);
taskRouter.delete("/:taskId/watchers", taskController.unwatch);
taskRouter.patch("/:taskId/pin", taskController.pin);
taskRouter.post("/:taskId/duplicate", taskController.duplicate);
